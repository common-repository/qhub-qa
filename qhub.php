...
$QdescURL = '<a href="http://'.plugins_url( 'Help.txt', __FILE__ ).'" target="_blank">Help</a>';
...
$new_meta_boxes = array(
	...
	"std" => '5',
	"title" => "Number of Questions to Display",
        "type" => "text",
...
{ ?>
    	<div class="wrap">
        	<h2>Qhub Q&A Wordpress Plugin Configuration.</h2>
            <p>Welcome to the Qhub Q&A Wordpress Plugin configuration, please enter your Qhub credentials below before setting up widgets.</p>
